...
const GuardForm: React.FC<GuardFormProps> = ({
  ...
  const handleSubmit = async (data: GuardFormData) => {
    if (!isEditMode) {
      // Show success dialog for new guards
      await onSubmit(data);
  ...
  // If in edit mode, show all tabs like before
  if (isEditMode) {
    return (
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        {/* Show all content for edit mode */}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-muted p-4 rounded-md">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-muted-foreground">Will be auto-generated upon creation</span>
                </div>
              </div>
            </div>
          )}
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader className="text-center">
            ...
            <DialogTitle className="text-xl font-semibold">Guard Added Successfully!</DialogTitle>
