      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <Card className="border border-border shadow-sm">
            <CardContent id="invoice-content" className="p-0 font-sans bg-white w-[210mm] mx-auto border border-border box-border">
              {/* Header */}
                  ...
                  <div className="text-right space-y-4">
                    <div className="h-12 w-32 flex items-end justify-end">
                      {companySettings?.company_seal_image_url && (
                        <img src={companySettings.company_seal_image_url} alt="Company Seal" className="h-16 w-auto object-contain opacity-80" />
                      )}
                    </div>
                    <div>
